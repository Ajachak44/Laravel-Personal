                ...
                <div class="p-6 text-gray-900">
                 <form action="{{ route('users.update',$user->id) }}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="my-3">
                            <input value="{{ old('name',$user->name) }}" placeholder="Enter Name" name="name" type="text" class="border-gray-300 shadow-sm rounded-lg width-1/2" >
                            @error('name')
                        ...
                        <div class="my-3">
                            <input value="{{ old('email',$user->email) }}" placeholder="Enter Email" name="email" type="text" class="border-gray-300 shadow-sm rounded-lg width-1/2" >
                            @error('email')
                            <p class="text-red-600 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
